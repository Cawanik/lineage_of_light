# ==========================================
# map_exporter.gd — Экспортёр карты в JSON, сука
# ==========================================
# export_map(building_grid, wall_system) — собирает всю ёбаную карту
#   в матрицу с ID сущностей и сохраняет в JSON файл.
#   Спавн-зоны, стены, здания — всё запихивает.
#   Возвращает абсолютный путь к файлу или пустую строку если обосрался.
# ==========================================
