# ==========================================
# lich_king.gd — Анимации Лич Кинга, пиздец какой крутой
# ==========================================
# _ready() — настраивает анимации и запускает idle на юг
# _setup_animations() — собирает SpriteFrames для всех 8 направлений,
#   зеркалит запад из востока, грузит idle фреймы или фоллбэк ротации,
#   короче вся ёбаная логика спрайтов тут
# ==========================================
