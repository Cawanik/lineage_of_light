# ==========================================
# move_marker.gd — Маркер куда ткнул мышкой, ёпт
# ==========================================
# _ready() — задаёт начальный радиус кольца
# _process(delta) — сужает кольцо, фейдит нахуй и убивает по таймеру
# _draw() — рисует эллипс (изометрия ~25°) и крестик внутри, вся эта красота
# ==========================================
