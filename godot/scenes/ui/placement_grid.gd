# ==========================================
# placement_grid.gd — Сетка для размещения построек, бля буду
# ==========================================
# _process(_delta) — трекает мышку и обновляет подсвеченную ячейку, сука
# _draw() — рисует ячейку с заливкой, рамкой и уголками для псевдо-3D понтов
# toggle_placement() — вкл/выкл режим размещения, туда-сюда блять
# get_cell_world_center() — возвращает центр ячейки в мировых координатах, нахуй
# ==========================================
